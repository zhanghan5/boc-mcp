...
from boc_mcp.health import readiness, liveness
...
_REGISTRIES = [reg_auth, reg_cluster]
...
def run() -> None:
    ...
    app.run(transport="streamable-http", host=config.mcp.host, port=config.mcp.port)
